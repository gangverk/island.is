...
const navigationItems = [
  ...
  {
    title: 'Eldri framtöl',
    href: '/skattframtol/application/old',
    active: false,
  },
]
      ...
      >
        ...
        <Box display="flex" flexDirection="column" rowGap={8}>
          <Stack space={4}>
            ...
            <Text>
              Hægt er að sækja um stuðning til kaupa á fyrstu íbúð, hvort sem
              einn kaupir eða í félagi við annan, að því gefnu að viðkomandi
              eigi að minnsta kosti 30% í íbúðinni.
            </Text>
          </Stack>
